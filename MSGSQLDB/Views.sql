-- =========================================
-- Database Views for FinOps Database
...
PRINT 'Views created:';
PRINT '- v_FinancialFact_Latest: Latest financial data per company';
PRINT '- v_WorkflowFact_Latest: Latest workflow data per company';
PRINT '- v_Company_SyncStatus: Company sync status overview';
PRINT '- v_Financial_Summary: Financial summary by company';
PRINT '- v_Workflow_Summary: Workflow summary by company';