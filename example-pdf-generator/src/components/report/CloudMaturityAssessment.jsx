// components/report/CloudMaturityAssessment.jsx
    ...
    <div className="w-full h-full bg-white p-8">
      ...
      <div className="grid grid-cols-2 gap-8 h-full">
        ...
        <div className="flex flex-col">
          ...
          {/* Overall Score Card */}
          <div className="mt-auto bg-gradient-to-r from-blue-500 to-indigo-600 p-5 rounded-lg text-white">
...
export default CloudMaturityAssessment
