// components/report/ReportGenerator.jsx
"use client"
...
import CloudMaturityAssessment from "./CloudMaturityAssessment"
  ...
  return (
    <>
      ...
      >
        ...
        >
          <CoverPage clientData={clientData} />
        </div> */}
        ...
        {/* <div
          ...
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        >
          <ExecutiveSummary clientData={clientData} page={1} />
        </div> */}
        ...
        {/* <div
          ...
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        >
          <ExecutiveSummary clientData={clientData} page={2} />
        </div> */}
        ...
        {/* <div
          ...
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        >
          <CloudMaturityAssessment clientData={clientData} />
        </div> */}
        ...
        {/* <div
          ...
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        >
          <CostOptimizationRecommendations clientData={clientData} />
        </div> */}
        {/* Add more pages as needed */}
        {/* <div
          className="page"
          style={{ width: "297mm", height: "210mm", overflow: "auto" }}
        >
          <Introduction clientData={clientData} page={1} />
        </div> */}
        {/* <div
          className="page"
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        >
          <Introduction clientData={clientData} page={2} />
        </div> */}
        <div
          className="page"
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        ...
        <div
          ...
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        >
          <MVPExecutiveSummary clientData={clientData} page={3} />
        </div>
        <div
          className="page"
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        >
          <MVPCloudMaturityAssessment clientData={clientData} />
        </div>
        <div
          className="page"
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        ...
        <div
          ...
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        >
          <CloudCostDashboard page={1} />
        </div>
        <div
          className="page"
          style={{ width: "297mm", height: "210mm", overflow: "hidden" }}
        >
          <CloudCostDashboard page={2} />
        </div>
      </div>
    </>
  )
